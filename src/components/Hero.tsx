...
export function Hero() {
	...
	return (
		// CORREÇÃO: Adicionando pt-20 (padding-top: 80px) para compensar a altura do Header (h-20)
		<section id="hero" className="relative w-full overflow-hidden bg-black text-white pt-20"> 
